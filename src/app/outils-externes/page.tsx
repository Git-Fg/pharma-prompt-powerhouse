...
// ❌ SUPPRIMER TOUTE LA LOGIQUE "toolsWithUseCases"
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        {allExternalTools.map((tool) => ( // ✅ Utiliser directement allExternalTools
            ...
            <CardContent className="flex-grow flex flex-col justify-between">
              <div>
                ...
                <ul className="space-y-2 mb-6">
                    {tool.use_cases && tool.use_cases.map((useCase) => ( // ✅ Accéder à tool.use_cases
