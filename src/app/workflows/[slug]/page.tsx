...
import { Clock, Target, ArrowLeft, ArrowRight, CheckCircle } from 'lucide-react';
    ...
    <Section>
      <Container maxWidth="4xl">
        ...
        <div className="section-margin-bottom">
          <Link href="/workflows" className="inline-flex items-center responsive-small-text text-muted-foreground hover:text-foreground">
      ...
      <div className="section-margin-bottom">
        ...
        <h1 className="responsive-large-heading mb-4">{workflow.title}</h1>
        <p className="responsive-section-title text-muted-foreground">{workflow.description}</p>
      ...
      {/* Table of Contents */}
      <Card className="section-margin-bottom">
        <CardHeader>
          <CardTitle className="responsive-card-title">Plan du Workflow</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="space-y-2">
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-red-500 rounded-full"></div>
              <span className="responsive-small-text">Le Problème</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
              <span className="responsive-small-text">Mon Approche Initiale (et ses limites)</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
              <span className="responsive-small-text">La Stratégie Optimisée</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
              <span className="responsive-small-text">Comparaison des Outils</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
              <span className="responsive-small-text">Le Prompt Final (à adapter)</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-gray-500 rounded-full"></div>
              <span className="responsive-small-text">Ce qu'il faut retenir</span>
            </div>
          </div>
        </CardContent>
      </Card>
