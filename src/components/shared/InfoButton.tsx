...
import { Info, Lightbulb, Globe, ExternalLink } from 'lucide-react';
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex gap-2">
            ...
            <Badge variant="outline" className="text-xs">
              {'⭐'.repeat(Math.floor(tool.confidenceScore / 2))} Confiance
            </Badge>
          </div>
        </div>
      </div>
