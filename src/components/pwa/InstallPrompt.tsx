  ...
  useEffect(() => {
    ...
    const checkAndSetInstalled = () => {
      if (window.matchMedia('(display-mode: standalone)').matches) {
        // eslint-disable-next-line react-hooks-extra/no-direct-set-state-in-use-effect -- Direct set acceptable pour l'initialisation de l'état PWA
        setIsInstalled(true)
      }
    }

    checkAndSetInstalled()
