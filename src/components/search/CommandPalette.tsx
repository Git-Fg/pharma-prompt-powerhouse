...
export function CommandPalette({ trigger }: CommandPaletteProps = {}) {
    ...
    const defaultTrigger = (
        <Button variant="outline" className="px-3 text-sm text-muted-foreground">
            ...
            Rechercher...
            <kbd className="pointer-events-none ml-auto inline-flex h-5 select-none items-center gap-1 rounded border bg-muted px-1.5 font-mono text-[var(--text-kbd)] font-medium text-muted-foreground opacity-100">
