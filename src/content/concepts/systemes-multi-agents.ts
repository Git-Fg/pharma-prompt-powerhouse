...
export const concept = {
  ...
  isFavorite: false,
  keyTakeaways: [
    'Les systèmes multi-agents simulent un comité d\'experts où chaque IA spécialisée apporte sa perspective.',
    'Cette approche réduit les biais et permet une analyse plus exhaustive des problèmes complexes.',
    'Même sans outils complexes, vous pouvez implémenter cette technique en définissant clairement les rôles dans vos prompts.',
  ],

  content: [
    {
      type: 'markdown',
      content: '## Le Pouvoir de la Collaboration',
    },
    {
      type: 'markdown',
    ...
    {
      type: 'markdown',
      content: '## Pourquoi est-ce une Approche Robuste ?',
    },
    {
      type: 'markdown',
      ...
      points: [
        {
          ...
          description: 'En forçant l\'IA à adopter des perspectives différentes, on réduit le risque qu\'elle s\'enferme dans une seule ligne de raisonnement. Un agent "épidémiologiste" n\'aura pas les mêmes réflexes qu\'un agent "pharmacologue".',
        },
        {
          title: 'Analyse Plus Exhaustive',
          description: 'Chaque agent est focalisé sur sa tâche, ce qui permet d\'explorer chaque facette d\'un problème avec plus de profondeur qu\'une IA généraliste qui essaierait de tout faire en même temps.',
        },
        {
          title: 'Transparence du Raisonnement',
          description: 'La structure même du prompt rend le processus de pensée de l\'IA beaucoup plus transparent. On peut voir clairement l\'avis de chaque "expert" avant la synthèse finale, ce qui permet de mieux évaluer la validité de la conclusion.',
        },
      ],
    },
    {
      type: 'markdown',
      content: '## Une Technique Avancée à votre Portée',
    },
    {
      type: 'markdown',
