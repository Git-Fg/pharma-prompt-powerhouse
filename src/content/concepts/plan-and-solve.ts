  ...
  content: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: 'card',
          title: 'Les Revues de Littérature Exhaustives',
          content: 'Lorsqu\'il faut synthétiser de nombreuses sources sur un sujet large, le plan initial garantit que toutes les facettes du problème seront explorées de manière cohérente.',
        },
        {
          type: 'card',
          title: 'La Création de Contenu Structuré',
          content: 'Pour générer un rapport, un cours ou une présentation, l\'agent peut d\'abord planifier la structure (introduction, chapitres, conclusion) puis générer chaque partie.',
        },
        {
          type: 'alert',
          variant: 'destructive',
          title: 'Le Point de Vigilance',
          content: 'Le principal risque est celui de l\'"hallucination stratégique". Si l\'agent interprète mal la demande initiale, tout son plan peut être hors-sujet ou biaisé. Il est crucial de valider le plan avant de le laisser continuer.',
        },
      ],
    },
    {
