...
export const concept = {
  ...
  isFavorite: false,
  keyTakeaways: [
    'Le désapprentissage cognitif est la perte progressive de compétences lorsqu\'une tâche est systématiquement déléguée à un système automatisé.',
    'L\'IA peut atrophier des compétences clés : raisonnement diagnostique, planification thérapeutique, communication scientifique.',
    'Contrairement aux calculatrices qui ne remplacent que le calcul, l\'IA remplace le cœur même du raisonnement.',
    'La solution est d\'utiliser l\'IA comme un tuteur cognitif qui améliore votre raisonnement, pas un remplacement.',
  ],
  content: [
    {
      type: 'markdown',
      content: '## L\'Effet Secondaire de l\'Automatisation',
    },
    {
      type: 'markdown',
    ...
    {
      type: 'markdown',
      content: '## Concrètement, quelles compétences sont menacées ?',
    },
    {
      type: 'markdown',
    ...
    {
      type: 'markdown',
      content: '## Comment l\'Éviter : La Philosophie du "Tuteur Cognitif"',
    },
    {
      type: 'markdown',
