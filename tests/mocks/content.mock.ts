...
export const createMockMarkdownBlock = (content: string): ContentBlock => ({
  type: 'markdown',
  content,
})

export const createMockAlertBlock = (content: string, variant = 'info'): ContentBlock => ({
  type: 'alert',
  content,
  variant: variant as any,
})

export const createMockCodeBlock = (content: string, language = 'javascript'): ContentBlock => ({
  type: 'codeBlock',
  content,
  language,
})

export const createMockCardBlock = (title: string, content: string): ContentBlock => ({
  type: 'card',
  title,
  content,
})
...
export const createMockTool = (overrides: Partial<ExternalTool> = {}): ExternalTool => ({
  slug: 'test-tool',
  title: 'Test Tool',
...
export const createMinimalGuide = (): Guide => createMockGuide({
  slug: 'minimal-guide',
  title: 'Minimal Guide',
...
export const createGuideWithoutTakeaways = (): Guide => createMockGuide({
  keyTakeaways: undefined,
})

export const createMinimalConcept = (): Concept => createMockConcept({
...
export const createConceptWithoutTakeaways = (): Concept => createMockConcept({
  keyTakeaways: undefined,
})

export const createMinimalTool = (): ExternalTool => createMockTool({
  slug: 'minimal-tool',
  title: 'Minimal Tool',
...
export const createToolWithoutConfidence = (): ExternalTool => createMockTool({
  confidenceScore: undefined,
  confidenceJustification: undefined,
})

export const createWorkflowWithoutConcepts = (): Workflow => createMockWorkflow({
  concepts: [],
})
