  ...
  describe('baseContentSchema validations', () => {
    it('should validate URL format in external tools', () => {
      const validTool = {
        ...
        category: 'AI Tools',
        personalReview: 'Great tool for testing',
        strongPoints: ['Easy to use', 'Fast performance'],
        vigilancePoints: ['Limited features', 'Requires internet'],
        confidenceScore: 4,
        confidenceJustification: 'Well-tested and reliable',
